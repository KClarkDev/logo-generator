...
class Square extends Shape {
  ...
  render() {
    ...
    <text x="150" y="120" font-size="60" font-family="sans-serif" text-anchor="middle" fill="${this.textColor}">${this.textContent}</text>
    </svg>`;
  }
}
...
class Triangle extends Shape {
  ...
  render() {
    ...
    <text x="150" y="150" font-size="60" font-family="sans-serif" text-anchor="middle" fill="${this.textColor}">${this.textContent}</text>
    </svg>`;
  }
}
